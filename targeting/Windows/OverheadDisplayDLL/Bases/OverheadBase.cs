...
{
    public partial class OverheadBase : UserControl
    {
        public OverheadBase()
        {
            InitializeComponent();
        ...
        /*public OverheadBase(Bases.OverheadSettings settings_reference)
        {
            InitializeComponent();
            ResizeBase();
            this.settings_reference = settings_reference;
        }*/

        public bool activated { get; private set; }

        //public Bases.OverheadSettings settings_reference { get; set; }
